...
### Slider 16 Navigation Buttons Style.
...
= Wordpress Slider Demo 2 Youtube Slider =
...
### First download the ZIP file slider,
...
3.4 Slider styles and colors.

Slider border size . Set the border for the slider
Slider Border color. Select the border color for the slider
Slider Border radius. Set the border radious for the slider
