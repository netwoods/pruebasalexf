...
<div>
	...
	<table border="0" id="rls_sliders_table">
		...
		<tr>
			<th>Name</th>
			<th>Slides</th>
			<th>Shortcode <pre>Enter the shortcode in your post or page content</pre></th>
			<th>Created</th>
			<th>Options</th>
		</tr>
		...
		<?php foreach ( $sliders as $slider  ): ?>
			...
			<tr class='<?php if ( $even_odd ) echo 'even'; else echo 'odd';  ?>'>
				...
				<td><strong><?php echo get_the_title( $slider->ID ) ?></strong></td>
				
				<td class="wp_rls_slides_width"><?php echo wprls_get_slides_count( $slider->ID ) ?></td>
				<td style="color:#000;font-size:18px;">[rlslider id=<?php echo $slider->ID ?>]</td>
				...
				<a id="slr_delete_slider" href="#">
					...
					<img alt="Delete" class="wp_rls_delete_img" data-id="<?php echo $slider->ID ?>" src="<?php echo  plugins_url( 'images/wp_rls_delete_slider_img.png', dirname( dirname( __FILE__ ) ) ) ?>" />
				</a>
