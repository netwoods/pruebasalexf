	...
	<?php
      ...
      <table width="100%" class="widefat" id="straymanage">
		...
		<tbody>
			...
			{
				?><tr><td colspan="5" align="center"><?php _e('No records available.', 'onclick-popup'); ?></td></tr><?php 
			}
			?>
		</tbody>
        </table>
	  ...
	  <div class="tablenav">
	  <h2>
	  <a class="button add-new-h2" href="<?php echo WP_onclickpopup_ADMIN_URL; ?>&amp;ac=add"><?php _e('Add New', 'onclick-popup'); ?></a>
	  <a class="button add-new-h2" target="_blank" href="<?php echo WP_onclickpopup_FAV; ?>"><?php _e('Help', 'onclick-popup'); ?></a>
	  </h2>
	  </div>
		<div style="height:5px"></div>
		<h3><?php _e('Plugin configuration option', 'onclick-popup'); ?></h3>
		<ol>
			<li><?php _e('Add the plugin in the posts or pages using short code.', 'onclick-popup'); ?></li>
			<li><?php _e('Add directly in to the theme using PHP code.', 'onclick-popup'); ?></li>
			<li><?php _e('Drag and drop the widget to your sidebar.', 'onclick-popup'); ?></li>
		</ol>
		<p class="description">
			<?php _e('Check official website for more information', 'onclick-popup'); ?>
			<a target="_blank" href="<?php echo WP_onclickpopup_FAV; ?>"><?php _e('click here', 'onclick-popup'); ?></a>
		</p>
	</div>
</div>