...
<script>
	...
	var lightbox_retinaSuffix = "<?php echo $paramssld['light_box_retinasuffix'];?>";
				...
				jQuery(".videogroup<?php echo $videogalleryID; ?>").vcolorbox({rel:'videogroup<?php echo $videogalleryID; ?>'});
				...
				?>
						<?php
							...
							if($videourl[1]=='youtube'){
								...
								?>
								<a class="vyoutube huge_it_videogallery_item"  href="https://www.youtube.com/embed/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
							...
							?>
								<a class="vvimeo huge_it_videogallery_item" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
				...
				?>
						<?php
							...
							if($videourl[1]=='youtube'){
								...
								?>
								<a class="vyoutube huge_it_videogallery_item videogroup<?php echo $videogalleryID; ?>"  href="https://www.youtube.com/embed/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
									<img src="<?php echo $thumb_pic; ?>" alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" />
									<div class="play-icon <?php echo $videourl[1]; ?>-icon"></div>
								</a>								
							<?php
							...
							?>
								<a class="vvimeo huge_it_videogallery_item videogroup<?php echo $videogalleryID; ?>" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>">
									<img src="<?php echo $imgsrc; ?>" alt="" />
									<div class="play-icon <?php echo $videourl[1]; ?>-icon"></div>
								</a>
							<?php
					...
					?>
							<?php
								...
								if($videourl[1]=='youtube'){
									...
									<a  class="vyoutube huge_it_videogallery_item videogroup<?php echo $videogalleryID; ?>"  href="https://www.youtube.com/embed/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>"></a>
									<img src="<?php echo $thumb_pic; ?>" alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" />				
								<?php
								}else {
								...
								?>
									<a  class="vvimeo huge_it_videogallery_item videogroup<?php echo $videogalleryID; ?>" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo str_replace('__5_5_5__','%',$row->name); ?>"></a>
									<img src="<?php echo $imgsrc; ?>" alt="<?php echo str_replace('__5_5_5__','%',$row->name); ?>" />
								<?php
								}
							?>
