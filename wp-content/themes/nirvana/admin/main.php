...
function nirvana_admin_scripts($hook) {
	...
	//wp_enqueue_style( 'cryout-admin-codemirror-style', get_template_directory_uri() . '/admin/css/codemirror.css', NULL, _CRYOUT_THEME_VERSION );
    ...
    //wp_enqueue_script('cryout-admin-codemirror-js',get_template_directory_uri() . '/admin/js/codemirror.min.js', NULL, _CRYOUT_THEME_VERSION ); // codemirror css markup
}
...
**************/
	...
	add_settings_section('layout_section', __('Layout Settings','nirvana'), 'cryout_section_layout_fn', 'nirvana-page');
	add_settings_section('header_section', __('Header Settings','nirvana'), 'cryout_section_header_fn', 'nirvana-page');
	add_settings_section('presentation_section', __('Presentation Page','nirvana'), 'cryout_section_presentation_fn', 'nirvana-page');
	add_settings_section('text_section', __('Text Settings','nirvana'), 'cryout_section_text_fn', 'nirvana-page');
	add_settings_section('appereance_section',__('Color Settings','nirvana') , 'cryout_section_appereance_fn', 'nirvana-page');
	add_settings_section('graphics_section', __('Graphics Settings','nirvana') , 'cryout_section_graphics_fn', 'nirvana-page');
	add_settings_section('post_section', __('Post Information Settings','nirvana') , 'cryout_section_post_fn', 'nirvana-page');
	add_settings_section('excerpt_section', __('Post Excerpt Settings','nirvana') , 'cryout_section_excerpt_fn', 'nirvana-page');
	add_settings_section('featured_section', __('Featured Image Settings','nirvana') , 'cryout_section_featured_fn', 'nirvana-page');
	add_settings_section('socials_section', __('Social Media Settings','nirvana') , 'cryout_section_social_fn', 'nirvana-page');
	add_settings_section('misc_section', __('Miscellaneous Settings','nirvana') , 'cryout_section_misc_fn', 'nirvana-page');
...
/*** appereance ***/
    ...
    add_settings_field('nirvana_sitebackground', __('Background Image','nirvana') , 'cryout_setting_sitebackground_fn', 'nirvana-page', 'appereance_section');
	add_settings_field('nirvana_generalcolors', __('General','nirvana') , 'cryout_setting_generalcolors_fn', 'nirvana-page', 'appereance_section');
	add_settings_field('nirvana_accentcolors', __('Accents','nirvana') , 'cryout_setting_accentcolors_fn', 'nirvana-page', 'appereance_section');
	add_settings_field('nirvana_titlecolors', __('Site Title','nirvana') , 'cryout_setting_titlecolors_fn', 'nirvana-page', 'appereance_section');
	add_settings_field('nirvana_menucolors', __('Main Menu','nirvana') , 'cryout_setting_menucolors_fn', 'nirvana-page', 'appereance_section');
	add_settings_field('nirvana_topmenucolors', __('Top Bar','nirvana') , 'cryout_setting_topmenucolors_fn', 'nirvana-page', 'appereance_section');
	add_settings_field('nirvana_contentcolors', __('Content','nirvana') , 'cryout_setting_contentcolors_fn', 'nirvana-page', 'appereance_section');
	add_settings_field('nirvana_frontpagecolors', __('Presentation Page','nirvana') , 'cryout_setting_frontpagecolors_fn', 'nirvana-page', 'appereance_section');
	add_settings_field('nirvana_sidecolors', __('Sidebar Widgets','nirvana') , 'cryout_setting_sidecolors_fn', 'nirvana-page', 'appereance_section');
	add_settings_field('nirvana_widgetcolors', __('Footer Widgets','nirvana') , 'cryout_setting_widgetcolors_fn', 'nirvana-page', 'appereance_section');
	add_settings_field('nirvana_linkcolors', __('Links','nirvana') , 'cryout_setting_linkcolors_fn', 'nirvana-page', 'appereance_section');
	add_settings_field('nirvana_metacolors', __('Post metas','nirvana') , 'cryout_setting_metacolors_fn', 'nirvana-page', 'appereance_section');
	add_settings_field('nirvana_socialcolors', __('Socials','nirvana') , 'cryout_setting_socialcolors_fn', 'nirvana-page', 'appereance_section');
	add_settings_field('nirvana_caption', __('Caption type','nirvana') , 'cryout_setting_caption_fn', 'nirvana-page', 'appereance_section');
...
/*** post exceprts***/
	...
	add_settings_field('nirvana_magazinelayout', __('Magazine Layout','nirvana') , 'cryout_setting_magazinelayout_fn', 'nirvana-page', 'excerpt_section');
...
<?php global $nirvanas; $nirvana_varalert = cryout_maxvarcheck(count($nirvanas));
	...
	<div id="main-options">
		...
		<span id="version">
		Nirvana v<?php echo _CRYOUT_THEME_VERSION; ?> by <a href="http://www.cryoutcreations.eu" target="_blank">Cryout Creations</a>
		</span>
	</div><!-- main-options -->
</div><!--lefty -->
